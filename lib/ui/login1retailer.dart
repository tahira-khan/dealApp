...
class Login1retailer extends StatefulWidget {
  @override
  _Login1retailerState createState() => _Login1retailerState();
}
class _Login1retailerState extends State<Login1retailer> {
