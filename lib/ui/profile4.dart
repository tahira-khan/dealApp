...
class _Profile2State extends State<Profile4> {
...
return Container();
 ...
 decoration: new BoxDecoration(
	gradient: new LinearGradient(
	  colors: [Color.fromRGBO(152, 230, 46, 1),Color.fromRGBO(181, 208, 17, 1)],
	  begin: FractionalOffset.centerLeft,
	  end: FractionalOffset.centerRight,
	)
  ),
...
elevation: 0,
	...
	crossAxisAlignment: CrossAxisAlignment.stretch,
        children: <Widget>[
 SizedBox(height:40),
        activityCard('Owner Name',Text('Sheldon Cooper')),
        SizedBox(height: 20),
        activityCard('Store Name',Text('MT Supermarket')),
             SizedBox(height: 20),
        activityCard('Email',Text('shellycooper@yahoo.com')),     
        SizedBox(height: 20),
        activityCard('Password',Text('***********')),    
         SizedBox(height: 20),
        activityCard('Mobile Number',Text('(084)654-8629)')),
	      SizedBox(height: 20),
